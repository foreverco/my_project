 ...
 */
 ...
 exports.find = function(collection,filter,option,callback){
   ...
   if(arguments.length == 2){
    ...
    //将查询条件设置为默认值{}
    //if(String(option)!= String({start:1,size:5,order:{time:-1}})){
    //或者filter中是否含有start,size,order中的一个或多个属性，若一个都没有，说明filter是查询条件
